...
Para utilizar el test construido debemos como primer paso calcular el promedio de los valores de la muestra "datos nueva versión". Una vez calculado, evaluamos nuestro estadístico observado. Si este pertenece en la Región de Rechazo, rechazamos \(H_0\). En el caso de no pertenecer a la región, no confirmamos que \(H_0\) sea verdadera sino que no tenemos la suficiente evidencia para rechazarla.  
...
$$  T_{obs} = \frac{42.99-41.98}{\sqrt{52.43 / 200}} $$
